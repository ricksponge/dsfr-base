...
<body id="top" class="fr-mb-12w">
  ...
  function preventSubmit(e) {
    ...
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4056"&gt;
            &lt;label class="fr-label" for="text-1"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-1-messages" name="text-1" id="text-1" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4057"&gt;
            &lt;label class="fr-label" for="text-2"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-2-messages" name="text-2" id="text-2" type="text"&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4058"&gt;
            &lt;label class="fr-label" for="text-3"&gt;
                Libellé champ de saisie
            &lt;/label&gt;
            &lt;input class="fr-input" aria-describedby="text-3-messages" name="text-3" id="text-3" type="text"&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4064">Extrait de code</button>
                                </h3>
                                <div id="snippet-4064" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4065">Extrait de code</button>
                                </h3>
                                <div id="snippet-4065" class="fr-collapse">
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4066">Extrait de code</button>
                                </h3>
                                <div id="snippet-4066" class="fr-collapse">
...
&lt;/fieldset&gt;
    ...
    &lt;/legend&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4070"&gt;
            &lt;label class="fr-label" for="text-disabled-1"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4071"&gt;
            &lt;label class="fr-label" for="text-disabled-2"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
    ...
    &lt;/div&gt;
    &lt;div class="fr-fieldset__element"&gt;
        &lt;div class="fr-input-group" id="input-group-4072"&gt;
            &lt;label class="fr-label" for="text-disabled-3"&gt;
                Libellé champ de saisie
                &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
            &lt;/label&gt;
...
&lt;/fieldset&gt;
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                ...
                                <div id="snippet-4076" class="fr-collapse">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4077">Extrait de code</button>
                                </h3>
                                <div id="snippet-4077" class="fr-collapse">
                        ...
                        <div class="fr-mb-12v">
                            <section class="fr-accordion">
                                <h3 class="fr-accordion__title">
                                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4078">Extrait de code</button>
                                </h3>
                                <div id="snippet-4078" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4079" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
