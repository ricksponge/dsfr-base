                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7662">Extrait de code</button>
                            </h3>
                            <div id="snippet-7662" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7661"&gt;
    &lt;label class="fr-label" for="text-input-text"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-text-messages" id="text-input-text" type="text"&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-7665" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7664"&gt;
    &lt;label class="fr-label" for="text-input-number"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" pattern="[0-9]*" inputmode="numeric" aria-describedby="text-input-number-messages" id="text-input-number" type="number"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7680">Extrait de code</button>
                            </h3>
                            <div id="snippet-7680" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7686">Extrait de code</button>
                            </h3>
                            <div id="snippet-7686" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7685"&gt;
    &lt;label class="fr-label" for="text-input-placeholder"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-placeholder-messages" placeholder="placeholder" id="text-input-placeholder" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7687">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7689">Extrait de code</button>
                            </h3>
                            <div id="snippet-7689" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7688"&gt;
    &lt;label class="fr-label" for="text-input-value"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" value="value" aria-describedby="text-input-value-messages" id="text-input-value" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7692">Extrait de code</button>
                            </h3>
                            <div id="snippet-7692" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--disabled" id="input-group-7693">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7695">Extrait de code</button>
                            </h3>
                            <div id="snippet-7695" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--disabled" id="input-group-7694"&gt;
    &lt;label class="fr-label" for="text-input-disabled"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-disabled-messages" disabled id="text-input-disabled" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group" id="input-group-7696">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7698">Extrait de code</button>
                            </h3>
                            <div id="snippet-7698" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group" id="input-group-7697"&gt;
    &lt;label class="fr-label" for="text-input-hint"&gt;
        Libellé champ de saisie
        &lt;span class="fr-hint-text"&gt;Texte de description additionnel&lt;/span&gt;
    &lt;/label&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--valid" id="input-group-7699">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7701">Extrait de code</button>
                            </h3>
                            <div id="snippet-7701" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--valid" id="input-group-7700"&gt;
    &lt;label class="fr-label" for="text-input-valid"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-valid-messages" id="text-input-valid" type="text"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-input-group fr-input-group--error" id="input-group-7702">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-7704">Extrait de code</button>
                            </h3>
                            <div id="snippet-7704" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-input-group fr-input-group--error" id="input-group-7703"&gt;
    &lt;label class="fr-label" for="text-input-error"&gt;
        Libellé champ de saisie
    &lt;/label&gt;
    &lt;input class="fr-input" aria-describedby="text-input-error-messages" id="text-input-error" type="text"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-7705" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
