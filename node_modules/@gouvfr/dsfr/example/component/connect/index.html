                ...
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-connect-group">
                            <button class="fr-connect" id="connect-1450" type="button">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-1454" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-connect-group"&gt;
    &lt;button class="fr-connect" id="connect-1452" type="button"&gt;
        &lt;span class="fr-connect__login"&gt;S’identifier avec&lt;/span&gt;
        &lt;span class="fr-connect__brand"&gt;FranceConnect&lt;/span&gt;
    &lt;/button&gt;
    &lt;p&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-connect-group">
                            <button class="fr-connect fr-connect--plus" id="connect-1455" type="button">
                                <span class="fr-connect__login">S’identifier avec</span>
                                <span class="fr-connect__brand">FranceConnect</span>
                            </button>
                            <p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-1459" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-connect-group"&gt;
    &lt;button class="fr-connect fr-connect--plus" id="connect-1457" type="button"&gt;
        &lt;span class="fr-connect__login"&gt;S’identifier avec&lt;/span&gt;
        &lt;span class="fr-connect__brand"&gt;FranceConnect&lt;/span&gt;
    &lt;/button&gt;
    &lt;p&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1460" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
