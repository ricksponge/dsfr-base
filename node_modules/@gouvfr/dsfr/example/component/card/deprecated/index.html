...
&lt;/div&gt;
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                ...
                <div id="snippet-1794" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12 fr-col-md-8"&gt;
        &lt;div class="fr-card fr-enlarge-link fr-card--horizontal"&gt;
            &lt;div class="fr-card__body"&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1795">Extrait de code</button>
                </h3>
                <div id="snippet-1795" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12 fr-col-md-8"&gt;
        &lt;div class="fr-card fr-enlarge-link fr-card--horizontal"&gt;
            &lt;div class="fr-card__body"&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1796">Extrait de code</button>
                </h3>
                <div id="snippet-1796" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-12 fr-col-md-8"&gt;
        &lt;div class="fr-card fr-card--horizontal"&gt;
            &lt;div class="fr-card__body"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1797" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
