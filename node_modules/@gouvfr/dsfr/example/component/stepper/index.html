                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4122">Extrait de code</button>
                            </h3>
                            <div id="snippet-4122" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4123">Extrait de code</button>
                            </h3>
                            <div id="snippet-4123" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-stepper"&gt;
    &lt;h2 class="fr-stepper__title"&gt;
        Titre de l’étape en cours
        &lt;span class="fr-stepper__state"&gt;Étape 2 sur 8&lt;/span&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4124" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
