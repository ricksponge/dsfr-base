        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <a aria-describedby="tooltip-4125" id="link-4126" href="#" class="fr-link">Exemple</a>
                        <span class="fr-tooltip fr-placement" id="tooltip-4125" role="tooltip">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</span>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-4129" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;a aria-describedby="tooltip-4127" id="link-4128" href="#" class="fr-link"&gt;Exemple&lt;/a&gt;
&lt;span class="fr-tooltip fr-placement" id="tooltip-4127" role="tooltip"&gt;Lorem [...] elit ut.&lt;/span&gt;
                    ...
                    <div class="fr-mb-6v">
                        <button aria-describedby="tooltip-4130" type="button" class="fr-btn--tooltip fr-btn">Information contextuelle</button>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-4132" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;button aria-describedby="tooltip-4131" type="button" class="fr-btn--tooltip fr-btn"&gt;Information contextuelle&lt;/button&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-grid-row fr-grid-row--gutters">
                            ...
                            <div class="fr-col-4 fr-col-sm-2">
                                <a class="fr-link" href="#" aria-describedby="tooltip-4136">Exemple</a>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4138">Extrait de code</button>
                            </h3>
                            <div id="snippet-4138" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-grid-row fr-grid-row--gutters"&gt;
    &lt;div class="fr-col-8 fr-col-sm-10"&gt;
        &lt;p&gt;Lorem [...] elit ut.&lt;/p&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div class="fr-share" id="share-4140">
                            <p class="fr-share__title">Partager la page</p>
                            <ul class="fr-btns-group">
                                <li>
                                    <a onclick="window.open(this.href,'Partager sur Facebook','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=450'); event.preventDefault();" aria-describedby="tooltip-4139" id="share-4141" href="https://www.facebook.com/sharer.php?u=[À MODIFIER - url de la page]" target="_blank" rel="noopener external" class="fr-btn--facebook fr-btn">Partager sur Facebook</a>
                                    <span class="fr-tooltip fr-placement" id="tooltip-4139" role="tooltip">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</span>
                                </li>
                                <li>
                                    <!-- Les paramètres de la reqûete doivent être URI-encodés (ex: encodeURIComponent() en js) -->
                                    <a onclick="window.open(this.href,'Partager sur X (anciennement Twitter)','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=420'); event.preventDefault();" id="share-4142" href="https://twitter.com/intent/tweet?url=[À MODIFIER - url de la page]&text=[À MODIFIER - titre ou texte descriptif de la page]&via=[À MODIFIER - via]&hashtags=[À MODIFIER - hashtags]" target="_blank" rel="noopener external" class="fr-btn--twitter-x fr-btn">Partager sur X (anciennement Twitter)</a>
                                </li>
                                <li>
                                    <!-- Les paramètres de la reqûete doivent être URI-encodés (ex: encodeURIComponent() en js) -->
                                    <a onclick="window.open(this.href,'Partager sur Bluesky','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=600,height=430'); event.preventDefault();" id="share-4143" href="https://bsky.app/intent/compose?text=[À MODIFIER - titre ou texte descriptif de la page]+[À MODIFIER - url de la page]" target="_blank" rel="noopener external" class="fr-btn--bluesky fr-btn">Partager sur Bluesky</a>
                                </li>
                                <li>
                                    <a onclick="window.open(this.href,'Partager sur LinkedIn','toolbar=no,location=yes,status=no,menubar=no,scrollbars=yes,resizable=yes,width=550,height=550'); event.preventDefault();" id="share-4144" href="https://www.linkedin.com/shareArticle?url=[À MODIFIER - url de la page]&title=[À MODIFIER - titre ou texte descriptif de la page]" target="_blank" rel="noopener external" class="fr-btn--linkedin fr-btn">Partager sur LinkedIn</a>
                                </li>
                                <li>
                                    <a id="share-4145" href="mailto:?subject=[À MODIFIER - objet du mail]&body=[À MODIFIER - titre ou texte descriptif de la page] [À MODIFIER - url de la page]" target="_blank" rel="noopener external" class="fr-btn--mail fr-btn">Partager par email</a>
                                </li>
                                <li>
                                    <button onclick="navigator.clipboard.writeText(window.location).then(function() {alert('Adresse copiée dans le presse papier.')});" type="button" id="share-4146" class="fr-btn--copy fr-btn">Copier dans le presse-papier</button>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-4155" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-share" id="share-4148"&gt;
    &lt;p class="fr-share__title"&gt;Partager la page&lt;/p&gt;
    &lt;ul class="fr-btns-group"&gt;
        &lt;li&gt;
...
&lt;/div&gt;
                                        ...
                                        <table id="tootltip-table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="tootltip-table-row-key-2" data-row-key="2">
                                                    ...
                                                    <td>
                                                        <button aria-describedby="tooltip-4156" type="button" class="fr-btn--tooltip fr-btn">Information contextuelle</button>
                                                        <span class="fr-tooltip fr-placement" id="tooltip-4156" role="tooltip">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed enim ut. Accumsan lacus vel facilisis volutpat est. Ut aliquam purus sit amet luctus. Lorem ipsum dolor sit amet consectetur adipiscing elit ut.</span>
                                                    </td>
                                                    <td>
                                                        Lorem ipsum dolor sit ame
                                                    </td>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-4158" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4159" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
