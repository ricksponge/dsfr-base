...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-1064" class="fr-collapse">
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1065">Extrait de code</button>
                            </h3>
                            <div id="snippet-1065" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div class="fr-upload-group"&gt;
    &lt;label class="fr-label" for="file-upload-multiple"&gt;
        Ajouter des fichiers
        &lt;span class="fr-hint-text"&gt;Indication : taille maximale : 500 Mo. Formats supportés : jpg, png, pdf. Plusieurs fichiers possibles. Lorem ipsum dolor sit amet, consectetur adipiscing.&lt;/span&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-1066">Extrait de code</button>
                            </h3>
                            <div id="snippet-1066" class="fr-collapse">
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-1067" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
