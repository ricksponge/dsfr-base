        ...
        <div class="fr-container">
            <div class="fr-grid-row fr-grid-row--center">
                <div class="fr-col-md-8 fr-col-12">
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-6038" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            ...
                            <div id="snippet-6040" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div id="callout-6039" class="fr-callout"&gt;
...
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-6041" class="fr-callout">
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6043">Extrait de code</button>
                            </h3>
                            <div id="snippet-6043" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div id="callout-6042" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-6044" class="fr-callout">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed </p>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6046">Extrait de code</button>
                            </h3>
                            <div id="snippet-6046" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div id="callout-6045" class="fr-callout"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
    &lt;button type="button" class="fr-btn"&gt;Libellé bouton&lt;/button&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-6047" class="fr-callout fr-icon-info-line">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed </p>
                            <button type="button" class="fr-btn">Libellé bouton</button>
                        </div>
                    ...
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6049">Extrait de code</button>
                            </h3>
                            <div id="snippet-6049" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div id="callout-6048" class="fr-callout fr-icon-info-line"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
    &lt;button type="button" class="fr-btn"&gt;Libellé bouton&lt;/button&gt;
&lt;/div&gt;
                    ...
                    <div class="fr-mb-6v">
                        <div id="callout-6050" class="fr-callout fr-callout--green-emeraude">
                            <h3 class="fr-callout__title">Titre mise en avant</h3>
                            <p class="fr-callout__text">Lorem ipsum dolor sit amet, consectetur adipiscing, incididunt, ut labore et dolore magna aliqua. Vitae sapien pellentesque habitant morbi tristique senectus et. Diam maecenas sed </p>
                        </div>
                    </div>
                    <div class="fr-mb-12v">
                        <section class="fr-accordion">
                            <h3 class="fr-accordion__title">
                                <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-6052">Extrait de code</button>
                            </h3>
                            <div id="snippet-6052" class="fr-collapse">
                                <pre class=" language-html"><code>&lt;div id="callout-6051" class="fr-callout fr-callout--green-emeraude"&gt;
    &lt;h3 class="fr-callout__title"&gt;Titre mise en avant&lt;/h3&gt;
    &lt;p class="fr-callout__text"&gt;Lorem [...] elit ut.&lt;/p&gt;
&lt;/div&gt;
</code></pre>
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-6053" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
