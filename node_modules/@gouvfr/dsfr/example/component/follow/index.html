            ...
            <div class="fr-mb-4v">
                <section class="fr-accordion">
                    <h3 class="fr-accordion__title">
                        <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4411">src/component/follow/style/_setting.scss</button>
                    </h3>
                    <div id="snippet-4411" class="fr-collapse">
...
$follow-icons: (
  ...
  youtube: youtube-fill,
        ...
        <div class="fr-mb-6v">
            <div class="fr-follow" id="follow-4412">
                <div class="fr-container">
                        ...
                        <div class="fr-col-12">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-btns-group">
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4413" href="[À MODIFIER - Lien vers le facebook de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--facebook fr-btn">Facebook</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4414" href="[À MODIFIER - Lien vers le twitter de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--twitter-x fr-btn">X (anciennement Twitter)</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4415" href="[À MODIFIER - Lien vers le bluesky de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--bluesky fr-btn">Bluesky</a>
                                    </li>
                                    <li>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4426">Extrait de code</button>
                </h3>
                <div id="snippet-4426" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4419"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12"&gt;
                &lt;div class="fr-follow__social"&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-mb-6v">
            <div class="fr-follow" id="follow-4428">
                <div class="fr-container">
                    <div class="fr-grid-row">
                        <div class="fr-col-12">
                            <div class="fr-follow__newsletter">
                                ...
                                <div>
                                    <ul class="fr-btns-group fr-btns-group--inline-md">
                                        <li>
                                            <button title="S‘abonner à notre lettre d’information" type="button" id="newsletter-button-4427" class="fr-btn">S'abonner</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4431">Extrait de code</button>
                </h3>
                <div id="snippet-4431" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4430"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12"&gt;
                &lt;div class="fr-follow__newsletter"&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-mb-6v">
            <div class="fr-follow" id="follow-4434">
                <div class="fr-container">
                    <div class="fr-grid-row">
                        <div class="fr-col-12">
                            <div class="fr-follow__newsletter">
                                ...
                                <div>
                                    <form action="">
                                        <div class="fr-input-group" id="input-group-4435">
                                            <label class="fr-label" for="newsletter-email-4432">
                                                Votre adresse électronique (ex. : nom@domaine.fr)
                                            </label>
                                            <div class="fr-input-wrap fr-input-wrap--addon">
                                                <input class="fr-input" title="Votre adresse électronique (ex. : nom@domaine.fr)" autocomplete="email" attributes="[object Object]" aria-describedby="newsletter-email-4432-hint-text newsletter-email-4432-messages" placeholder="Votre adresse électronique (ex. : nom@domaine.fr)" id="newsletter-email-4432" type="email">
                                                <button title="S‘abonner à notre lettre d’information" type="button" id="newsletter-button-4433" class="fr-btn">S'abonner</button>
                                            </div>
                                            <div class="fr-messages-group" id="newsletter-email-4432-messages" aria-live="polite">
                                            </div>
                                        </div>
                                        <p id="newsletter-email-4432-hint-text" class="fr-hint-text">En renseignant votre adresse électronique, vous acceptez de recevoir nos actualités par courriel. Vous pouvez vous désinscrire à tout moment à l’aide des liens de désinscription ou en nous contactant.</p>
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                ...
                <div id="snippet-4440" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4438"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12"&gt;
                &lt;div class="fr-follow__newsletter"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-col-12 fr-col-md-4">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-btns-group">
                                    ...
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4445" href="[À MODIFIER - Lien vers le bluesky de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--bluesky fr-btn">Bluesky</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4446" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--linkedin fr-btn">Linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4447" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--instagram fr-btn">Instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4448" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--youtube fr-btn">Youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4457">Extrait de code</button>
                </h3>
                <div id="snippet-4457" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4450"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
                &lt;div class="fr-follow__newsletter"&gt;
...
&lt;/div&gt;
                        ...
                        <div class="fr-col-12 fr-col-md-4">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-btns-group">
                                    ...
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4464" href="[À MODIFIER - Lien vers le bluesky de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--bluesky fr-btn">Bluesky</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4465" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--linkedin fr-btn">Linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4466" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--instagram fr-btn">Instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4467" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--youtube fr-btn">Youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4478">Extrait de code</button>
                </h3>
                <div id="snippet-4478" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4470"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
                &lt;div class="fr-follow__newsletter"&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-mb-6v">
            <div class="fr-follow" id="follow-4480">
                <div class="fr-container">
                    <div class="fr-grid-row">
                        <div class="fr-col-12 fr-col-md-8">
                            <div class="fr-follow__newsletter">
                                ...
                                <div>
                                    <div id="newsletter-alert-4479" class="fr-alert fr-alert--success">
                        ...
                        <div class="fr-col-12 fr-col-md-4">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-btns-group">
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4481" href="[À MODIFIER - Lien vers le facebook de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--facebook fr-btn">Facebook</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4482" href="[À MODIFIER - Lien vers le twitter de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--twitter-x fr-btn">X (anciennement Twitter)</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4483" href="[À MODIFIER - Lien vers le bluesky de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--bluesky fr-btn">Bluesky</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4484" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--linkedin fr-btn">Linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4485" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--instagram fr-btn">Instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4486" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--youtube fr-btn">Youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4495">Extrait de code</button>
                </h3>
                <div id="snippet-4495" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4488"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
                &lt;div class="fr-follow__newsletter"&gt;
...
&lt;/div&gt;
        ...
        <div class="fr-mb-6v">
            <div class="fr-follow" id="follow-4498">
                <div class="fr-container">
                    <div class="fr-grid-row">
                        <div class="fr-col-12 fr-col-md-8">
                            <div class="fr-follow__newsletter">
                                ...
                                <div>
                                    <form action="">
                                        <div class="fr-input-group fr-input-group--error" id="input-group-4499">
                                            <label class="fr-label" for="newsletter-email-4496">
                                                Votre adresse électronique (ex. : nom@domaine.fr)
                                            </label>
                                            <div class="fr-input-wrap fr-input-wrap--addon">
                                                <input class="fr-input" title="Votre adresse électronique (ex. : nom@domaine.fr)" autocomplete="email" aria-describedby="newsletter-email-4496-hint-text newsletter-email-4496-messages" placeholder="Votre adresse électronique (ex. : nom@domaine.fr)" id="newsletter-email-4496" type="email">
                                                <button title="S‘abonner à notre lettre d’information" type="button" id="newsletter-button-4497" class="fr-btn">S'abonner</button>
                                            </div>
                                            <div class="fr-messages-group" id="newsletter-email-4496-messages" aria-live="polite">
                                                <p class="fr-message fr-message--error" id="newsletter-email-4496-message-error">Le format de l’adresse electronique saisie n’est pas valide. Le format attendu est : nom@domaine.fr</p>
                                            </div>
                                        </div>
                                        <p id="newsletter-email-4496-hint-text" class="fr-hint-text">En renseignant votre adresse électronique, vous acceptez de recevoir nos actualités par courriel. Vous pouvez vous désinscrire à tout moment à l’aide des liens de désinscription ou en nous contactant.</p>
                                    </form>
                                </div>
                            </div>
                        </div>
                        <div class="fr-col-12 fr-col-md-4">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-btns-group">
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4500" href="[À MODIFIER - Lien vers le facebook de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--facebook fr-btn">Facebook</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4501" href="[À MODIFIER - Lien vers le twitter de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--twitter-x fr-btn">X (anciennement Twitter)</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4502" href="[À MODIFIER - Lien vers le bluesky de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--bluesky fr-btn">Bluesky</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4503" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--linkedin fr-btn">Linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4504" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--instagram fr-btn">Instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="social-button-4505" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-btn--youtube fr-btn">Youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4516">Extrait de code</button>
                </h3>
                <div id="snippet-4516" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow" id="follow-4508"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
                &lt;div class="fr-follow__newsletter"&gt;
                        ...
                        <div class="fr-col-12">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-links-group">
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4517" href="[À MODIFIER - Lien vers le facebook de l'organisation]" target="_blank" rel="noopener external" class="fr-link--facebook fr-link">facebook</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4518" href="[À MODIFIER - Lien vers le twitter de l'organisation]" target="_blank" rel="noopener external" class="fr-link--twitter-x fr-link">twitter-x</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4519" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-link--instagram fr-link">instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4520" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-link--linkedin fr-link">linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4521" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-link--youtube fr-link">youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
&lt;/div&gt;
                    ...
                    <div class="fr-grid-row">
                        ...
                        <div class="fr-col-12 fr-col-md-4">
                            <div class="fr-follow__social">
                                ...
                                <ul class="fr-links-group">
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4528" href="[À MODIFIER - Lien vers le facebook de l'organisation]" target="_blank" rel="noopener external" class="fr-link--facebook fr-link">facebook</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4529" href="[À MODIFIER - Lien vers le twitter de l'organisation]" target="_blank" rel="noopener external" class="fr-link--twitter-x fr-link">twitter-x</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4530" href="[À MODIFIER - Lien vers l'instagram de l'organisation]" target="_blank" rel="noopener external" class="fr-link--instagram fr-link">instagram</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4531" href="[À MODIFIER - Lien vers le linkedin de l'organisation]" target="_blank" rel="noopener external" class="fr-link--linkedin fr-link">linkedin</a>
                                    </li>
                                    <li>
                                        <a title="[À MODIFIER - Intitulé du lien] - nouvelle fenêtre" id="link-4532" href="[À MODIFIER - Lien vers le youtube de l'organisation]" target="_blank" rel="noopener external" class="fr-link--youtube fr-link">youtube</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="fr-mb-12v">
            <section class="fr-accordion">
                <h3 class="fr-accordion__title">
                    <button type="button" class="fr-accordion__btn" aria-expanded="false" aria-controls="snippet-4538">Extrait de code</button>
                </h3>
                <div id="snippet-4538" class="fr-collapse">
                    <pre class=" language-html"><code>&lt;div class="fr-follow"&gt;
    &lt;div class="fr-container"&gt;
        &lt;div class="fr-grid-row"&gt;
            &lt;div class="fr-col-12 fr-col-md-8"&gt;
                ...
                <div class="fr-col-12 fr-col-md-6 fr-col-lg-4">
                    <div class="fr-modal__body">
                        <div class="fr-modal__header">
                            <button aria-controls="fr-theme-modal" title="Fermer" type="button" id="button-4539" class="fr-btn--close fr-btn">Fermer</button>
                        </div>
