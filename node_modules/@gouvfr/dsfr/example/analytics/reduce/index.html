        ...
        <div class="fr-container">
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    ...
                    <div data-fr-analytics-action="libellé envoyé à l'analytics" id="accordion-524" class="fr-collapse">
                        <!-- données de test -->
                        <div>
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    ...
                    <div id="accordion-525" class="fr-collapse">
                        <!-- données de test -->
                        <div>
                            <h4 class="fr-h4">Contenu </h4>
                            <ul>
            ...
            <div class="fr-mb-6v">
                <section class="fr-accordion">
                    ...
                    <div id="accordion-526" class="fr-collapse">
                        <!-- données de test -->
                        <div>
                            <h4 class="fr-h4">Contenu </h4>
                            <img class="fr-responsive-img" src="../../../example/img/placeholder.16x9.png" alt="" />
